                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">                       
                      <select name="job_type" id="job_type" style="width:280px; height:25px;" class="select2" required>
                          ...
                          <option value="Half Time" <?php if($row['job_type']=='Half Time'){?>selected<?php }?>>Part Time</option>
                          <option value="Hourly" <?php if($row['job_type']=='Hourly'){?>selected<?php }?>>Freelancer</option>
                    </select>
                    </div>
                  </div>
                  <div class="form-group">
